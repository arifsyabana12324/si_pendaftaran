...
<html>
    <head>
        <title>Cetak Data Semua Agama</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3><u>DATA SELURUH AGAMA</u></h3>
                        <table class="table table-bordered table-striped table-hover"> 
                        <tbody>
                                <thead>
                                <tr>
									<th width="20%"><center>No.</center></th><th width="20%"><center>ID</center></th><th width="20%"><center>Agama</center></th>
								</tr>
								</thead>
							<tbody>
