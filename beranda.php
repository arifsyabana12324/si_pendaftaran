    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di STMIK ROYAL KISARAN Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Pendaftaran Mahasiswa/i Baru</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nama Maba</th><th>Jenis Kelamin</th><th>Asal Sekolah</th><th>Agama</th><th>Jurusan</th><th>Nim Sekolah</th>
                            </tr>
                        </thead>
                        <tbody>
